...
$string['updatefileextensionmessage'] = 'Changing the file extension from \'{$a->originalextension}\' to \'{$a->newextension}\' may result in a file which cannot be opened.';
$string['updatefileextensiontitle'] = 'Rename file changing the extension?';
$string['updateinvalidfiletype'] = 'You cannot change the file extension to \'.{$a->fileextension}\' The accepted file types are: {$a->acceptedfiletypes}';
